...
class Circling(): #main class
    ...
    def callback(self, msg): #function for obstacle avoidance
        ...
        print ('Back: {}'.format(msg.ranges[180])) #lidar data for back side
      	...
      	#Obstacle Avoidance
        self.distance = 0.7
        if msg.ranges[0] > self.distance and msg.ranges[15] > self.distance and msg.ranges[345] > self.distance and msg.ranges[5] > self.distance and msg.ranges[355] > self.distance and msg.ranges[10] > self.distance and msg.ranges[350] > self.distance: 
